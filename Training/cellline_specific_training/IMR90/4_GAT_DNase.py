...
def train_model(data_dir, model_save_path):
    ...
    "/mnt/nfs/bowei/CHROME/model/cellline_specific/IMR/CNN_DNase_baseline/best_model.pt",
    map_location="cuda:7"
    )
...
if __name__ == "__main__":
    ...
    model_save_path = "/mnt/nfs/bowei/CHROME/model/cellline_specific/IMR/GAT_DNase/"
