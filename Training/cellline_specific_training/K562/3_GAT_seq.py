...
def train_model(data_dir, model_save_path, model_type="flattened"):
    ...
    "/mnt/nfs/bowei/CHROME/model/cellline_specific/K/CNN_seq_baseline/best_model.pt",
    map_location="cuda:7"
    )
...
if __name__ == "__main__":
    ...
    model_save_path = "/mnt/nfs/bowei/CHROME/model/cellline_specific/K/GAT_seq_only/"
