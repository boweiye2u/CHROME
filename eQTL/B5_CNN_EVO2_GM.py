...
for fold, (train_idx, val_idx) in enumerate(kf.split(gm_data, label_indices)):
    ...
    model_path = f"/mnt/nfs/bowei/CHROME/model/eQTL/EVO2_center_embedding/gm_model_fold_{fold+1}.pt"
    torch.save(model.state_dict(), model_path)
    print(f"✅ Model for fold {fold+1} saved to {model_path}")

    metrics_path = f"/mnt/nfs/bowei/CHROME/model/eQTL/EVO2_center_embedding/gm_metrics_fold_{fold+1}.txt"
...
avg_path = "/mnt/nfs/bowei/CHROME/model/eQTL/EVO2_center_embedding/gm_metrics_average.txt"
