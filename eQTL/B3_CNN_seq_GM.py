...
with open("/mnt/nfs/bowei/CHROME/data/eQTL/gm_with_embeddings_seq.pkl", "rb") as f:
...
for fold, (train_idx, val_idx) in enumerate(kf.split(gm_data, label_indices)):
    ...
    model_path = f"/mnt/nfs/bowei/CHROME/model/eQTL/Seq_CNN_embedding/gm_model_fold_{fold+1}.pt"
    torch.save(model.state_dict(), model_path)
    print(f"✅ Model for fold {fold+1} saved to {model_path}")

    metrics_path = f"/mnt/nfs/bowei/CHROME/model/eQTL/Seq_CNN_embedding/gm_metrics_fold_{fold+1}.txt"
...
avg_path = "/mnt/nfs/bowei/CHROME/model/eQTL/Seq_CNN_embedding/gm_metrics_average.txt"
