...
for fold, (train_idx, val_idx) in enumerate(kf.split(gm_data, label_indices)):
    ...
    model_path = f"/mnt/nfs/bowei/CHROME/model/eQTL/EVO2_GAT_embedding/imr_model_fold_{fold+1}.pt"
    ...
    metrics_path = f"/mnt/nfs/bowei/CHROME/model/eQTL/EVO2_GAT_embedding/imr_metrics_fold_{fold+1}.txt"
...
avg_path = "/mnt/nfs/bowei/CHROME/model/eQTL/EVO2_GAT_embedding/imr_metrics_average.txt"
